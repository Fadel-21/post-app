  ...
  <div className="header-container  container-xxl ">        
    ...
    <div className="d-flex align-items-center flex-wrap">
      ...
      <div className="header-search py-3 py-lg-0 me-3">
        ...
        <div id="kt_header_search" className="header-search d-flex align-items-center w-lg-250px" data-kt-search-keypress="true" data-kt-search-min-length={2} data-kt-search-enter="enter" data-kt-search-layout="menu" data-kt-search-responsive="false" data-kt-menu-trigger="auto" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-end" data-kt-search="true">
          ...
          <form data-kt-search-element="form" className="w-100 position-relative" autoComplete="off">	
            ...
            <span className="svg-icon svg-icon-2 search-icon position-absolute top-50 translate-middle-y ms-4"><svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/*begin::Input*/}
            <input type="text" className="form-control custom-form-control ps-13" name="search" defaultValue placeholder="Find Goods" data-kt-search-element="input" />
            {/*end::Input*/}
            {/*begin::Spinner*/}
          ...
          {/*end::Form*/}
          {/*begin::Menu*/}
          <div data-kt-search-element="content" className="menu menu-sub menu-sub-dropdown w-300px w-md-350px py-7 px-7 overflow-hidden" data-kt-menu="true">
            {/*begin::Wrapper*/}
              ...
              <div data-kt-search-element="results" className="d-none">
                ...
                <div className="scroll-y mh-200px mh-lg-350px">
                  ...
                  <a href="#" className="d-flex text-dark text-hover-primary align-items-center mb-5">
                    {/*begin::Symbol*/}
                    <div className="symbol symbol-40px me-4">
                      <img src="/metronic8/demo9/assets/media/avatars/300-2.jpg" alt="" />
                    </div>
                    {/*end::Symbol*/}
                    {/*begin::Title*/}
                    <div className="d-flex flex-column justify-content-start fw-semibold">
                  ...
                  <a href="#" className="d-flex text-dark text-hover-primary align-items-center mb-5">
                    {/*begin::Symbol*/}
                    <div className="symbol symbol-40px me-4">
                      <img src="/metronic8/demo9/assets/media/avatars/300-14.jpg" alt="" />
                    </div>
                    {/*end::Symbol*/}
                    {/*begin::Title*/}
                    <div className="d-flex flex-column justify-content-start fw-semibold">
                  ...
                  <a href="#" className="d-flex text-dark text-hover-primary align-items-center mb-5">
                    {/*begin::Symbol*/}
                    <div className="symbol symbol-40px me-4">
                      <img src="/metronic8/demo9/assets/media/avatars/300-11.jpg" alt="" />
                    </div>
                    {/*end::Symbol*/}
                    {/*begin::Title*/}
                    <div className="d-flex flex-column justify-content-start fw-semibold">
                  ...
                  <a href="#" className="d-flex text-dark text-hover-primary align-items-center mb-5">
                    ...
                    <div className="symbol symbol-40px me-4">
                      <span className="symbol-label bg-light">                             
                        <img className="w-20px h-20px" src="/metronic8/demo9/assets/media/svg/brand-logos/volicity-9.svg" alt="" />                          
                      </span>
                    </div>
                    {/*end::Symbol*/}
                    {/*begin::Title*/}
                  ...
                  <a href="#" className="d-flex text-dark text-hover-primary align-items-center mb-5">
                    ...
                    <div className="symbol symbol-40px me-4">
                      <span className="symbol-label bg-light">                             
                        <img className="w-20px h-20px" src="/metronic8/demo9/assets/media/svg/brand-logos/tvit.svg" alt="" />                          
                      </span>
                    </div>
                    {/*end::Symbol*/}
                    {/*begin::Title*/}
                  ...
                  <a href="#" className="d-flex text-dark text-hover-primary align-items-center mb-5">
                    ...
                    <div className="symbol symbol-40px me-4">
                      <span className="symbol-label bg-light">                             
                        <img className="w-20px h-20px" src="/metronic8/demo9/assets/media/svg/misc/infography.svg" alt="" />                          
                      </span>
                    </div>
                    {/*end::Symbol*/}
                    {/*begin::Title*/}
                  ...
                  <a href="#" className="d-flex text-dark text-hover-primary align-items-center mb-5">
                    ...
                    <div className="symbol symbol-40px me-4">
                      <span className="symbol-label bg-light">                             
                        <img className="w-20px h-20px" src="/metronic8/demo9/assets/media/svg/brand-logos/leaf.svg" alt="" />                          
                      </span>
                    </div>
                    {/*end::Symbol*/}
                    {/*begin::Title*/}
                  ...
                  <a href="#" className="d-flex text-dark text-hover-primary align-items-center mb-5">
                    ...
                    <div className="symbol symbol-40px me-4">
                      <span className="symbol-label bg-light">                             
                        <img className="w-20px h-20px" src="/metronic8/demo9/assets/media/svg/brand-logos/tower.svg" alt="" />                          
                      </span>
                    </div>
                    {/*end::Symbol*/}
                    {/*begin::Title*/}
                  ...
                  <a href="#" className="d-flex text-dark text-hover-primary align-items-center mb-5">
                    ...
                    <div className="symbol symbol-40px me-4">
                      <span className="symbol-label bg-light">                             
                        ...
                        <span className="svg-icon svg-icon-2 svg-icon-primary"><svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <a href="#" className="d-flex text-dark text-hover-primary align-items-center mb-5">
                    ...
                    <div className="symbol symbol-40px me-4">
                      <span className="symbol-label bg-light">                             
                        ...
                        <span className="svg-icon svg-icon-2 svg-icon-primary"><svg width={18} height={18} viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <form data-kt-search-element="advanced-options-form" className="pt-1 d-none">
              ...
              {/*begin::Input group*/}
              <div className="mb-5">
                <select name="timezone" aria-label="Select a Timezone" data-control="select2" data-placeholder="date_period" className="form-select form-select-sm form-select-solid select2-hidden-accessible" data-select2-id="select2-data-1-pvt6" tabIndex={-1} aria-hidden="true" data-kt-initialized={1}>
                  <option value="next" data-select2-id="select2-data-3-3duc">Within the next</option>
                  <option value="last">Within the last</option>
                  <option value="between">Between</option>
                  <option value="on">On</option>
                </select><span className="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-2-dxa8" style={{width: '100%'}}><span className="selection"><span className="select2-selection select2-selection--single form-select form-select-sm form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabIndex={0} aria-disabled="false" aria-labelledby="select2-timezone-h6-container" aria-controls="select2-timezone-h6-container"><span className="select2-selection__rendered" id="select2-timezone-h6-container" role="textbox" aria-readonly="true" title="Within the next">Within the next</span><span className="select2-selection__arrow" role="presentation"><b role="presentation" /></span></span></span><span className="dropdown-wrapper" aria-hidden="true" /></span>
              </div>
              {/*end::Input group*/}
              {/*begin::Input group*/}
              <div className="row mb-8">
                ...
                {/*begin::Col*/}
                <div className="col-6"> 
                  <select name="date_typer" aria-label="Select a Timezone" data-control="select2" data-placeholder="Period" className="form-select form-select-sm form-select-solid select2-hidden-accessible" data-select2-id="select2-data-4-vupt" tabIndex={-1} aria-hidden="true" data-kt-initialized={1}>
                    <option value="days" data-select2-id="select2-data-6-15jk">Days</option>
                    <option value="weeks">Weeks</option>
                    <option value="months">Months</option>
                    <option value="years">Years</option>
                  </select><span className="select2 select2-container select2-container--bootstrap5" dir="ltr" data-select2-id="select2-data-5-czwt" style={{width: '100%'}}><span className="selection"><span className="select2-selection select2-selection--single form-select form-select-sm form-select-solid" role="combobox" aria-haspopup="true" aria-expanded="false" tabIndex={0} aria-disabled="false" aria-labelledby="select2-date_typer-m1-container" aria-controls="select2-date_typer-m1-container"><span className="select2-selection__rendered" id="select2-date_typer-m1-container" role="textbox" aria-readonly="true" title="Days">Days</span><span className="select2-selection__arrow" role="presentation"><b role="presentation" /></span></span></span><span className="dropdown-wrapper" aria-hidden="true" /></span>
                </div>
                {/*end::Col*/}
              </div>
              {/*end::Input group*/}
              ...
              <div className="d-flex justify-content-end">
                ...
                <a href="/metronic8/demo9/../demo9/pages/search/horizontal.html" className="btn btn-sm fw-bold btn-primary" data-kt-search-element="advanced-options-form-search">Search</a>
              </div>
              {/*end::Actions*/}
            </form>
            {/*end::Preferences*/}
      ...
      <div className="d-flex align-items-center py-3 py-lg-0">
        {/*begin::Item*/}
        <div className="me-3">
          <a href="#" className="btn btn-icon btn-custom btn-active-color-primary position-relative" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
            {/*begin::Svg Icon | path: icons/duotune/general/gen007.svg*/}
            <span className="svg-icon svg-icon-1 svg-icon-white"><svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/*end::Svg Icon*/}                        <span className="bullet bullet-dot bg-success h-6px w-6px position-absolute translate-middle top-0 start-50 animation-blink" />
          </a>
          {/*begin::Menu*/}
          <div className="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
            {/*begin::Heading*/}
            <div className="d-flex flex-column bgi-no-repeat rounded-top" style={{backgroundImage: 'url("/metronic8/demo9/assets/media/misc/menu-header-bg.jpg")'}}>
              {/*begin::Title*/}                                   
            ...
            <div className="tab-content">
              ...
              <div className="tab-pane fade" id="kt_topbar_notifications_1" role="tabpanel">
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      <div className="symbol symbol-35px me-4">
                        <span className="symbol-label bg-light-danger">      
                          ...
                          <span className="svg-icon svg-icon-2 svg-icon-danger"><svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      <div className="symbol symbol-35px me-4">
                        <span className="symbol-label bg-light-warning">      
                          ...
                          <span className="svg-icon svg-icon-2 svg-icon-warning"><svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      <div className="symbol symbol-35px me-4">
                        <span className="symbol-label bg-light-success">      
                          ...
                          <span className="svg-icon svg-icon-2 svg-icon-success"><svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      <div className="symbol symbol-35px me-4">
                        <span className="symbol-label bg-light-info">      
                          ...
                          <span className="svg-icon svg-icon-2 svg-icon-info"><svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      <div className="symbol symbol-35px me-4">
                        <span className="symbol-label bg-light-warning">      
                          ...
                          <span className="svg-icon svg-icon-2 svg-icon-warning"><svg width={24} height={25} viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="py-3 text-center border-top">
                  <a href="/metronic8/demo9/../demo9/pages/user-profile/activity.html" className="btn btn-color-gray-600 btn-active-color-primary">
                    View All 
                    {/*begin::Svg Icon | path: icons/duotune/arrows/arr064.svg*/}
                    <span className="svg-icon svg-icon-5"><svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
                ...
                <div className="d-flex flex-column px-9">
                  ...
                  <div className="text-center px-4">
                    <img className="mw-100 mh-200px" alt="image" src="/metronic8/demo9/assets/media/illustrations/sigma-1/1.png" />
                  </div>
                  {/*end::Illustration*/}
                </div>
                {/*end::Wrapper*/}
        ...
        {/*begin::Item*/}
        <div className="me-3">
          <a href="#" className="btn btn-icon btn-custom btn-active-color-primary" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
          ...
          <div className="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
            ...
            <div className="menu-item px-3">
              <div className="menu-content d-flex align-items-center px-3">
                ...
                <div className="symbol symbol-50px me-5">
                  <img alt="Logo" src="/metronic8/demo9/assets/media/avatars/300-1.jpg" />
                </div>
                {/*end::Avatar*/}
                {/*begin::Username*/}
                <div className="d-flex flex-column">
            ...
            <div className="menu-item px-5">
              <a href="/metronic8/demo9/../demo9/account/overview.html" className="menu-link px-5">
                My Profile
              </a>
            </div>
            {/*end::Menu item*/}
            {/*begin::Menu item*/}
            <div className="menu-item px-5">
              <a href="/metronic8/demo9/../demo9/apps/projects/list.html" className="menu-link px-5">
            ...
            <div className="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start" data-kt-menu-offset="-15px, 0">
              ...
              <div className="menu-sub menu-sub-dropdown w-175px py-4">
                {/*begin::Menu item*/}
                <div className="menu-item px-3">
                  <a href="/metronic8/demo9/../demo9/account/referrals.html" className="menu-link px-5">
                    Referrals
                  </a>
                </div>
                {/*end::Menu item*/}
                {/*begin::Menu item*/}
                <div className="menu-item px-3">
                  <a href="/metronic8/demo9/../demo9/account/billing.html" className="menu-link px-5">
                    Billing
                  </a>
                </div>
                {/*end::Menu item*/}
                {/*begin::Menu item*/}            
                <div className="menu-item px-3">
                  <a href="/metronic8/demo9/../demo9/account/statements.html" className="menu-link px-5">
                    Payments
                  </a>
                </div>
                {/*end::Menu item*/}
                {/*begin::Menu item*/}            
                <div className="menu-item px-3">
                  <a href="/metronic8/demo9/../demo9/account/statements.html" className="menu-link d-flex flex-stack px-5">
                    Statements
                    <i className="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" aria-label="View your statements" data-bs-original-title="View your statements" data-kt-initialized={1} />
                  </a>
                </div>
                {/*end::Menu item*/}
                {/*begin::Menu separator*/}
            ...
            <div className="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start" data-kt-menu-offset="-15px, 0">
              <a href="#" className="menu-link px-5">
                <span className="menu-title position-relative">
                  ...
                  <span className="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">
                    English <img className="w-15px h-15px rounded-1 ms-2" src="/metronic8/demo9/assets/media/flags/united-states.svg" alt="" />
                  </span>
                </span>
              </a>
              {/*begin::Menu sub*/}
              <div className="menu-sub menu-sub-dropdown w-175px py-4">
                {/*begin::Menu item*/}
                <div className="menu-item px-3">
                  <a href="/metronic8/demo9/../demo9/account/settings.html" className="menu-link d-flex px-5 active">
                    <span className="symbol symbol-20px me-4">
                      <img className="rounded-1" src="/metronic8/demo9/assets/media/flags/united-states.svg" alt="" />
                    </span>
                    English
                  </a>
                </div>
                ...
                {/*begin::Menu item*/}
                <div className="menu-item px-3">
                  <a href="/metronic8/demo9/../demo9/account/settings.html" className="menu-link d-flex px-5">
                    <span className="symbol symbol-20px me-4">
                      <img className="rounded-1" src="/metronic8/demo9/assets/media/flags/spain.svg" alt="" />
                    </span>
                    Spanish
                  </a>
                </div>
                ...
                <div className="menu-item px-3">
                  <a href="/metronic8/demo9/../demo9/account/settings.html" className="menu-link d-flex px-5">
                    <span className="symbol symbol-20px me-4">
                      <img className="rounded-1" src="/metronic8/demo9/assets/media/flags/germany.svg" alt="" />
                    </span>
                    German
                  </a>
                </div>
                ...
                <div className="menu-item px-3">
                  <a href="/metronic8/demo9/../demo9/account/settings.html" className="menu-link d-flex px-5">
                    <span className="symbol symbol-20px me-4">
                      <img className="rounded-1" src="/metronic8/demo9/assets/media/flags/japan.svg" alt="" />
                    </span>
                    Japanese
                  </a>
                </div>
                ...
                <div className="menu-item px-3">
                  <a href="/metronic8/demo9/../demo9/account/settings.html" className="menu-link d-flex px-5">
                    <span className="symbol symbol-20px me-4">
                      <img className="rounded-1" src="/metronic8/demo9/assets/media/flags/france.svg" alt="" />
                    </span>
                    French
                  </a>
                </div>
            ...
            <div className="menu-item px-5 my-1">
              <a href="/metronic8/demo9/../demo9/account/settings.html" className="menu-link px-5">
                Account Settings
              </a>
            </div>
            {/*end::Menu item*/}
            {/*begin::Menu item*/}
            <div className="menu-item px-5">
              <a href="/metronic8/demo9/../demo9/authentication/layouts/corporate/sign-in.html" className="menu-link px-5">
                Sign Out
              </a>
            </div>
            {/*end::Menu item*/}
